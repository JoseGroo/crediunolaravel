...
class ClientesRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'medio_publicitario_id'     => 'required|int',
            'grupo_id'                  => 'nullable|int',
            ...
            'vivienda'                  => 'nullable|max:100',
            'renta'                     => 'nullable|numeric'
        ];

        if($this->route()->getName() == 'clientes.create_post' || $this->route()->getName() == 'clientes.create') {

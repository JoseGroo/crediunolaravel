...
@section('content')
    ...
    {{ Form::open([ 'route' => ['clientes.create_post' ], 'method' => 'POST', 'id' => 'frmCrear', 'enctype' => 'multipart/form-data' ]) }}
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="form-group">
                            {{ Form::label('medio_publicitario_id', 'Medio publicitario') }}
                            {{ Form::select('medio_publicitario_id', $medios_publicitarios, null, ['class' => 'form-control', 'placeholder' => 'Seleccionar opcion']) }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            {{ Form::select('grupo_id', $grupos, null, ['class' => 'form-control', 'placeholder' => 'Seleccionar opcion']) }}
                        </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            {{ Form::text('vivienda', null, [ 'class' => 'form-control' ]) }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            {{ Form::text('renta', null, [ 'class' => 'form-control just-decimal' ]) }}
                        </div>
                    </div>
...
@section("scripts")
    ...
    {!! JsValidator::formRequest('App\Http\Requests\ClientesRequest', '#frmCrear') !!}

    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="form-group">
                        {{ Form::label('medio_publicitario_id', __('validation.attributes.medio_publicitario')) }}
                        {{ Form::select('medio_publicitario_id', $medios_publicitarios, $model->medio_publicitario_id, ['class' => 'form-control', 'placeholder' => 'Seleccionar opcion']) }}
                    </div>
                </div>

                <div class="col-md-4 col-sm-6 col-12">
                    <div class="form-group">
                        {{ Form::label('grupo_id', __('validation.attributes.grupo')) }}
                        {{ Form::select('grupo_id', $grupos, $model->grupo_id, ['class' => 'form-control', 'placeholder' => 'Seleccionar opcion']) }}
                    </div>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        {{ Form::text('vivienda', $model->vivienda, [ 'class' => 'form-control' ]) }}
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        {{ Form::text('renta', $model->renta, [ 'class' => 'form-control just-decimal' ]) }}
                    </div>
                </div>
